...
- **배치 기간:** 2026-02-20 ~ 2026-02-21 (KST)
- **작성/정리 시각:** 2026-02-21 01:34 KST
...
- **02-20 밤**: 초기 연결/페어링 진행, gateway 인증 이슈 확인
- **02-21 00:20~00:40**: 모델/구독/API 과금 경로 분리 진단
- **02-21 00:40~01:00**: API 키 리스크 정리 + codex 기본 모델 복귀
- **02-21 01:00~01:20**: 블로그 저장소/배포 파이프라인 구성
- **02-21 01:20~01:34**: 글 구조 개선(프로젝트 흐름 + 운영 포인트 + 회고)
